                ...
                \begin{itemize}
                    ...
                    \item For each key on sub-tree of a Node, there's 3 cases:
                        \begin{align*}
                            ...
                            \forall y \in K\left(p_{i}\right);\mspace{20mu}& k_i < y < k_{i + 1};\mspace{20mu} 0 < i < \symit{l} \wedge i \in \symbb{N} \\
                            \forall y \in K\left(p_{\symit{l}}\right);\mspace{20mu}& k_{\symit{l}} < y
                        \end{align*}
...
\begin{frame}[t,allowframebreaks,allowdisplaybreaks]
    ...
    \begin{figure}[h!]
        \includegraphics[width=0.5\linewidth]{resources/made/mendivelso_a2_btree.eps}
    \end{figure}
\end{frame}
...
\begin{frame}[t,allowframebreaks,allowdisplaybreaks]
    ...
    \end{columns}
    \begin{figure}[h!]
        \includegraphics[width=0.55\linewidth]{resources/made/btree_search_step0.eps}
    \end{figure}
    ...
    \end{columns}
    \begin{figure}[h!]
        \includegraphics[width=0.55\linewidth]{resources/made/btree_search_step1.eps}
    \end{figure}
    ...
    \end{columns}
    \begin{figure}[h!]
        \includegraphics[width=0.55\linewidth]{resources/made/btree_search_step2.eps}
    \end{figure}
    ...
    \end{columns}
    \begin{figure}[h!]
        \includegraphics[width=0.55\linewidth]{resources/made/btree_search_step3.eps}
    \end{figure}
    ...
    \end{columns}
    \begin{figure}[h!]
        \includegraphics[width=0.55\linewidth]{resources/made/btree_search_step4.eps}
    \end{figure}
    ...
    \end{columns}
    \begin{figure}[h!]
        \includegraphics[width=0.55\linewidth]{resources/made/btree_search_step5.eps}
    \end{figure}
    ...
    \end{columns}
    \begin{figure}[h!]
        \includegraphics[width=0.55\linewidth]{resources/made/btree_search_step6.eps}
    \end{figure}
    ...
    \end{columns}
    \begin{figure}[h!]
        \includegraphics[width=0.55\linewidth]{resources/made/btree_search_step7.eps}
    \end{figure}
    ...
    \end{columns}
    \begin{figure}[h!]
        \includegraphics[width=0.55\linewidth]{resources/made/btree_search_step8.eps}
    \end{figure}
    ...
    \end{columns}
    \begin{figure}[h!]
        \includegraphics[width=0.45\linewidth]{resources/made/btree_search_step9.eps}
    \end{figure}
\end{frame}
